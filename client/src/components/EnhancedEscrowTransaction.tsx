...
import TransactionStatusTracker, { type EscrowStatus } from "@/components/TransactionStatusTracker";
import {
        ...
        <Card variant="elevated" padding="lg">
          <CardHeader>
            ...
            <Text variant="body" muted>
              Create a secure escrow transaction for {productName} with real-time status tracking
            </Text>
          </CardHeader>
